package com.flyfiref.dsscm.tools;
...
public class RsaUtil {
    public static void main(String[] args) throws Exception {
        //主方法用于测试，以及获取加密后的密码以存入数据库，不然自己就无法登录了
        Map<String,String> keyMap =generateKey();
        String pubKey = keyMap.get("publicKeyStr");
        System.out.println("PubKey: "+pubKey);
        String priKey = keyMap.get("privateKeyStr");
        System.out.println("PriKey: "+priKey);
        //管理员密码，这里输入111111后面就用111111登录
        System.out.println("111111 -> "+encryptByPublicKey("111111",pubKey));
        //其他密码
        System.out.println("000000 -> "+encryptByPublicKey("000000",pubKey));
    }
